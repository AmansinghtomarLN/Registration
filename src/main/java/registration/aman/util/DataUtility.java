...
public class DataUtility {
    ...
    private static final SimpleDateFormat timeFormatter = new SimpleDateFormat(
            APP_TIME_FORMAT);
    private static final SimpleDateFormat sqlFormatter = new SimpleDateFormat(
            SQL_DATE_FORMAT);
    
    private static final SimpleDateFormat viewFormatter = new SimpleDateFormat(
                    VIEW_DATE_FORMAT	);
    ...
    /**
     * Converts Util Date into SQL Date
     * 
     * @param val
     * @return
     */
    public static java.sql.Date getSQLDate(Date val) {
        ...
        try {
            date = new java.sql.Date(val.getYear(), val.getMonth(), val.getDate());
